...
@Component({
  ...
  styles: [`
    ...
    @media (max-width: 599px) {
      ...
      .goal-header { gap: 8px; margin-bottom: 8px; }
      .goal-icon { font-size: 1.75rem; }
      .goal-title h3 { font-size: 1rem; }
      .goal-actions button {
        min-width: 44px;
        min-height: 44px;
        width: 44px;
      ...
      .goal-amounts .current { font-size: 1rem; }
      .goal-amounts .target { font-size: 0.8rem; }
      .goal-footer .percent { font-size: 0.85rem; }
      .goal-footer .target-date { font-size: 0.75rem; }
      .goal-complete-badge { font-size: 0.75rem; padding: 5px 10px; }
    }
  `]
})
